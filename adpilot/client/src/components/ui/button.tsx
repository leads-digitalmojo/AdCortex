...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-bold uppercase tracking-[0.04em] " +
  ...
  "hover-elevate active-elevate-2",
  {
    variants: {
      variant: {
        ...
        outline:
          "border-[1.5px] border-foreground/80 bg-card text-foreground shadow-xs hover:bg-accent hover:text-foreground",
        secondary:
        ...
        link:
          "border-none normal-case tracking-normal underline-offset-4 hover:underline text-primary p-0 h-auto",
      },
      size: {
